...
\begin{exercise}
    ...
    \end{figure}
    葡萄糖、果糖、蔗糖甜度比较：\blank 葡萄糖和果糖属于\blank ，分子式相同，其结构式为\blank 葡萄糖和果糖都是还原性糖，如何理解\blank 分别写出核糖和脱氧核糖的结构式\blank 核糖和脱氧核糖能发生的反应类型有\blank 手性碳原子是\blank 甘油醛的对映异构体结构分别为\blank 自然界中的葡萄糖和果糖都具有\blank 构型。\blank 蔗糖在酸或酶作用下水解为\blank ，化学方程式为\blank 麦芽糖在酸或酶作用下水解为\blank ，化学方程式为\blank 乳糖也是二糖，乳糖发酵得到\blank ，是酸奶酸味的主要来源。
    \begin{answer}
        \begin{inparaenum}[\quad\textsuperscript{\arabic{enumi}}]
            \item[\setcounter{enumi}{1}\textsuperscript{\arabic{enumi}}] example
            \item example
        \end{inparaenum}
    \end{answer}
\end{exercise}
