...
\begin{subexercise}
    ...
    \begin{center}
        \begin{inparaenum}[\qquad A. ]
            \item[\setcounter{enumi}{1}A. ] 煤$\rightarrow$石油
            \item 石油$\rightarrow$乙烯
            \item 油脂$\rightarrow$甘油
            \item 淀粉$\rightarrow$乙醇
        \end{inparaenum}
    \end{center}
    \begin{answer}
        A
    ...
    \end{point}
    \begin{explanation}
        煤与石油无法相互转化，A选项错误；通过分馏，可从石油中提取乙烯，B选项正确；油脂可水解为甘油，C选项正确；淀粉糖化发酵后可得到乙醇，D选项正确。
    \end{explanation}
\end{subexercise}
\end{document}
