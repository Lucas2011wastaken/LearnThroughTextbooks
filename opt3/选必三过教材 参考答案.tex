...
\newcommand{\blank}{ \underbar{\quad\addtocounter{blanks}{1}\textsuperscript{\arabic{blanks}}$\blacktriangle$\quad} }% 空格样式
...
\newcounter{blanks}% 为空格编号所定义的计数器
\AtBeginEnvironment{subexercise}{\setcounter{blanks}{0}}
\AtBeginEnvironment{exercise}{\setcounter{blanks}{0}}
...
\begin{subexercise}
    ...
    \begin{answer}
        \begin{inparaenum}[\quad\textsuperscript{\arabic{enumi}}]
            ...
            \item $\mathop{\chemfig{[:18,0.5]*5(=----)}}\limits_{\mbox{\kaishu 环戊烯}}$、$\mathop{\chemfig{[,0.5]*4(--(-)=-)}}\limits_{\mbox{\kaishu 1-甲基环丁烯}}$、$\mathop{\chemfig{[,0.5]*4(=-(-)--)}}\limits_{\mbox{\kaishu 3-甲基环丁烯}}$、$\mathop{\chemfig{[,0.5]*4(--(=)--)}}\limits_{\mbox{\kaishu 甲亚基环丁烷}}$、$\mathop{\chemfig{[:-30,0.5]*3(--(-[:30]=^[:0])-)}}\limits_{\mbox{\kaishu 乙烯基环丙烷}}$、$\mathop{\chemfig{[,0.5]*3(-(=^-[:30])--)}}\limits_{\mbox{\kaishu 乙亚基环丙烷}}$、$\mathop{\chemfig{[:-30,0.5]*3(=-(-[:30]-[:-30])-)}}\limits_{\mbox{\kaishu 3-乙基环丙烯}}$、$\mathop{\chemfig{[:-30,0.5]*3(=-(-[:30])(-[:150])-)}}\limits_{\mbox{\kaishu 3,3-二甲基环丙烯}}$、\\$\mathop{\chemfig{[:-30,0.5]*3(--(-[:30]-[:-30])=)}}\limits_{\mbox{\kaishu 1-乙基环丙烯}}$
...
\begin{subexercise}
    ...
    \begin{answer}
        \begin{inparaenum}[\quad\textsuperscript{\arabic{enumi}}]
            ...
            \item 低温时，一方面苯基较大，有空间位阻，另一方面，苯酚分子间可形成氢键，阻碍苯酚与水形成氢键；温度稍高时，苯酚之间的氢键断裂，可与水形成氢键互溶
            ...
            \item 白色沉淀溶解
            \item 产生白色沉淀
            \item 氧原子电负性大，极化$\ce{O-H}$键使氢原子易于电离；解离生成的苯氧负离子（$\ce{C6H5O-}$）p-$\pi$共轭很稳定，故解离倾向性大
            \item 产生白色沉淀
...
\begin{subexercise}
    \begin{multicols}{2}
        ...
        完成72页第2题（还原反应特征）\\
        完成72页第3题（醇的氧化特点、同分异构体判断）
        \begin{flushright}\textbf{二氢醛一氢酮无氢不氧化}\end{flushright}
...
\begin{subexercise}\textcolor{white}{spac}
    ...
    步骤一：反应回流。在圆底烧瓶中加入体积比为1:1的乙醇和冰醋酸，再加入乙醇和浓硫酸的混合物。将圆底烧瓶与球形冷凝管连接，用电加热套或油浴加热圆底烧瓶，并保持温度为110$\sim$120 ℃(如下左图)。反应物和产物以气体形式从圆底烧瓶逸出进入冷凝管内管，球形冷凝管的外管以低进高出方式持续通入冷水，进入内管的气体遇冷又凝结为液体回流至圆底烧瓶中。
...
\begin{subexercise}
    ...
    \begin{answer}
        \begin{inparaenum}[\quad\textsuperscript{\arabic{enumi}}]
            ...
            \item $\chemfig{[,0.6] CH(-[2]CH_2-OH)(-[6]CH_2-OH)-OH }\ce{+ 3C17H35COOH <=>T[$\triangle$] 3H2O + }\chemfig{[,0.6] CH(-[2]CH_2-OOC-C_{17}H_{35})(-[6]CH_2-OOC-C_{17}H_{35})-OOC-C_{17}H_{35} }$\\\vspace{0.5em}
            \item $\chemfig{[,0.6] CH(-[2]CH_2-OH)(-[6]CH_2-OH)-OH }\ce{+ 3C17H33COOH <=>T[$\triangle$] 3H2O + }\chemfig{[,0.6] CH(-[2]CH_2-OOC-C_{17}H_{33})(-[6]CH_2-OOC-C_{17}H_{33})-OOC-C_{17}H_{33} }$\\
            \item $\chemfig{[,0.6] CH(-[2]CH_2-OOC-C_{17}H_{35})(-[6]CH_2-OOC-C_{17}H_{35})-OOC-C_{17}H_{35} }\ce{+ 3NaOH ->T[$\triangle$] \chemfig{[,0.6] CH(-[2]CH_2-OH)(-[6]CH_2-OH)-OH} + 3C17H35COONa}$
            \item $\chemfig{[,0.6] CH(-[2]CH_2-OOC-C_{17}H_{33})(-[6]CH_2-OOC-C_{17}H_{33})-OOC-C_{17}H_{33}}\ce{+ 3H2 ->T[催化剂][$\triangle$]}\chemfig{[,0.6] CH(-[2]CH_2-OOC-C_{17}H_{35})(-[6]CH_2-OOC-C_{17}H_{35})-OOC-C_{17}H_{35}}$
        \end{inparaenum}
    \end{answer}
\end{subexercise}
\begin{subexercise}
    ...
    \begin{answer}
        \begin{inparaenum}[\quad\textsuperscript{\arabic{enumi}}]
            ...
            \item $\chemfig{[:-30,0.4] *6(-=-([,0.6]-C(=[2]O)-NH_2)=-=)}\ce{+ H2O + HCl ->T[$\triangle$] NH4Cl + }\chemfig{[:-30,0.4] *6(-=-([,0.6]-C(=[2]O)-OH)=-=)}$
...
\begin{exercise}
    ...
    \end{answer}
    \begin{note}
        题\textsuperscript{1}中未指明所选用无机酸，故答案按照离子方程式写出；题\textsuperscript{5}未指明具体有机物，故只给出通式；题\textsuperscript{7}丙炔被酸性高锰酸钾的产物为乙酸和二氧化碳，若想得到丙酸还需其他的处理，本答案按照前者给出。
    \end{note}
\end{exercise}
\setcounter{subexercise}{0}
\addtocounter{exercise}{1}
\begin{subexercise}
    资料卡片：实验室有机合成常用装置仪器名称\blank ，能够在加热时起到\blank 、\blank 、\blank 和\blank 等实验操作。工业化合成需要使用\blank （仪器名称）。
    \begin{answer}
        \begin{inparaenum}[\quad\textsuperscript{\arabic{enumi}}]
            \item[\setcounter{enumi}{1}\textsuperscript{\arabic{enumi}}] 三颈烧瓶、球形冷凝管、恒压滴液漏斗、温度计、磁力搅拌器（搅拌子）
            \item 搅拌
            \item 温度监测
            \item 加料
            \item 冷凝回流
...
\end{subexercise}
\begin{subexercise}
    \fs{[2023新课标28]}实验室由安息香制备二苯乙二酮的反应式如下：
    \[
        \chemfig{[,0.4] (=[2]O)(-[:210]*6(-=-=-=))-[:-30](-[6]OH)-[:30]*6(-=-=-=)}\ce{->T[$\ce{FeCl3}$][$\triangle$]\chemfig{[,0.4] (=[2]O)(-[:210]*6(-=-=-=))-[:-30](=[6]O)-[:30]*6(-=-=-=)}}
    \]
    相关信息列表如下：
    \begin{table}[!h]
        \centering
        \begin{tabular}{|l|l|l|l|l|}
            \hline
            物质    & 性状    & 熔点/$^\circ$C & 沸点/$^\circ$C & 溶解性              \\ \hline
            安息香   & 白色固体  & 133          & 344          & 难溶于冷水、溶于热水、乙醇、乙酸 \\ \hline
            二苯乙二酮 & 淡黄色固体 & 95           & 347          & 不溶于水、溶于乙醇、苯、乙酸   \\ \hline
            冰乙酸   & 无色液体  & 17           & 118          & 与水、乙醇互溶          \\ \hline
        \end{tabular}
    \end{table}
    装置示意图如左图所示，实验步骤为：\circled{1}在圆底烧瓶中加入10mL冰乙酸、5mL水及9.0g $\ce{FeCl3 . 6H2O}$，边搅拌边加热，至固体全部溶解。\circled{2}停止加热，待沸腾平息后加入2.0g安息香，加热回流45$\sim$60min。\circled{3}加入50mL水，煮沸后冷却，有黄色固体析出。\circled{4}过滤，并用冷水洗涤固体3次，得到粗品。\circled{5}粗品用75\%的乙醇重结晶，干燥后得淡黄色结晶1.6g。
    ...
    \begin{flushright}
        \begin{figure}[ht!]
            \flushright
            \includegraphics[width=0.12\textwidth]{assists/image15.png}
        \end{figure}
    \end{flushright}\vspace{-12em}

    (1)仪器A中应加入\blank(填“水”或“油”)作为热传导介质。
    \begin{answer}
        \begin{inparaenum}[\quad\textsuperscript{\arabic{enumi}}]
            \item[\setcounter{enumi}{1}\textsuperscript{\arabic{enumi}}] 油
        \end{inparaenum}
    \end{answer}
    \begin{explanation}
        安息香的熔点为133$^\circ$C，而90$^\circ$C以上的加热需求就不再推荐水浴加热。
    \end{explanation}

    (2)仪器B的名称是\blank；冷却水应从\blank(填“a”或“b”)口通入。
    \begin{answer}
        \begin{inparaenum}[\quad\textsuperscript{\arabic{enumi}}]
            \item[\setcounter{enumi}{2}\textsuperscript{\arabic{enumi}}] 球形冷凝管
            \item a
        \end{inparaenum}
    \end{answer}

    (3)实验步骤\circled{2}中，安息香必须待沸腾平息后方可加入，其主要目的是\blank。
    \begin{answer}
        \begin{inparaenum}[\quad\textsuperscript{\arabic{enumi}}]
            \item[\setcounter{enumi}{4}\textsuperscript{\arabic{enumi}}] 防暴沸
        \end{inparaenum}
    \end{answer}
    \begin{point}
        实验安全
    \end{point}
    \begin{explanation}
        向沸腾的溶液中加入固体安息香，会提供成核点，导致过热液体瞬间剧烈沸腾，增加安全风险。
    \end{explanation}

    (4)在本实验中，$\ce{FeCl3 . 6H2O}$为氧化剂且过量，其还原产物为\blank；某同学尝试改进本实验：采用催化量的$\ce{FeCl3 . 6H2O}$并通入空气制备二苯乙二酮。该方案是否可行\blank ？简述判断理由\blank。
    \begin{answer}
        \begin{inparaenum}[\quad\textsuperscript{\arabic{enumi}}]
            \item[\setcounter{enumi}{5}\textsuperscript{\arabic{enumi}}] $\ce{FeCl2}$
            \item 可以
            \item 空气中的氧气可以氧化$\ce{Fe^2+}$到$\ce{Fe^3+}$，从而形成循环，可以继续氧化安息香
        \end{inparaenum}
    \end{answer}
    \begin{point}
        氧化还原反应
    ...
    (5)本实验步骤\circled{1}~在\circled{3}乙酸体系中进行，乙酸除作溶剂外，另一主要作用是\blank。
    \begin{answer}
        \begin{inparaenum}[\quad\textsuperscript{\arabic{enumi}}]
            \item[\setcounter{enumi}{8}\textsuperscript{\arabic{enumi}}] 抑制三价铁离子水解
        \end{inparaenum}

        (6)若粗品中混有少量未氧化的安息香，可用少量\blank 洗涤的方法除去(填标号)。若要得到更高纯度的产品，可用重结晶的方法进一步提纯。\qquad a.热水\qquad b.乙酸\qquad  c.冷水\qquad  d.乙醇
        \begin{answer}
            \begin{inparaenum}[\quad\textsuperscript{\arabic{enumi}}]
                \item[\setcounter{enumi}{9}\textsuperscript{\arabic{enumi}}] a
            \end{inparaenum}
        \end{answer}
        \begin{point}
            过滤后洗涤剂的选择
        \end{point}
        \begin{explanation}
            安息香溶于热水，而产物不溶于热水，选择热水进行洗涤可以除去粗品中的安息香。
        \end{explanation}

        (7)本实验的产率最接近于\blank (填标号)。\qquad a.85\%\qquad b.80\%\qquad c.75\%\qquad  d.70\%
        \begin{answer}
            \begin{inparaenum}[\quad\textsuperscript{\arabic{enumi}}]
                \item[\setcounter{enumi}{10}\textsuperscript{\arabic{enumi}}] b
            \end{inparaenum}
        \end{answer}
        \begin{point}
            产率的估算
        \end{point}
        \begin{explanation}
            安息香与二苯乙二酮的相对分子量接近，直接进行估算$\dfrac{1.6 g}{2.0 g}\times 100\% = 80\%$
        \end{explanation}
    \end{answer}
\end{subexercise}
\begin{exercise}
    \begin{multicols}{2}
        \noindent 完91页第1题（合成路线设计-卤代烃中间过渡）\\
        完成91页第2题（氯丁橡胶合成路线设计-逆合成）\\
        完成91页第3题（制备1,4-环己二醇合成路线设计）\\
        完成92页第4题（乙烯合成1,4-二氧杂环己烷，合成路线设计）\\
        完成92页5题（甲苯合成苯甲酸苯甲酯，合成路线设计）\\
        完成92页第6题（根据信息进行合成路线设计）\\
        完成92页第7题（借鉴流程进行合成路线设计）
    \end{multicols}
    \begin{answer}
        \fs{略}
    \end{answer}
...
\begin{exercise}
    \begin{multicols}{2}
        \noindent 完95页第1题（混合物分离提纯）\\
        完成95页第2题（乙酸的酸性）\\
        完成95页第3题（醇和酚区别）\\
        完成95页第4题（有机物的杀菌消毒）\\
        完成95页5题（乙醇性质与化学键的断裂）\\
        完成95页第6题（碳卤键、碳碳双键和醛基的性质）\\
        完成95页第7题（分子内基团间的相互作用）\\
        完成95页第8题（引入羟基的方法）\\
        完成95页第9题（有机合成路线与反应类型判断）\\
        完成96页第10题（有机物溶解度影响因素）\\
        完成96页11题（有机物鉴别）\\
        完成96页第12题（有机物结构推断）\\
        完成96页第13题（酿醋工艺）\\
        完成96页第14题（药物的合成）\\
...
\end{exercise}
\begin{exercise}
    阅读并完成98页实验乙酸乙酯的制备与性质。实验目的为\blank 实验仪器和药品为\blank 讨论答案1：\blank 讨论答案2：\blank
    \begin{answer}
        \begin{inparaenum}[\quad\textsuperscript{\arabic{enumi}}]
            \item[\setcounter{enumi}{1}\textsuperscript{\arabic{enumi}}] 制备乙酸乙酯并探究其性质（酯化反应）
            \item 试管、试管夹、烧杯、量筒、胶头滴管、玻璃导管、乳胶管、橡胶塞、铁架台、酒精灯、火柴、秒表、碎瓷片、乙醇、乙酸、浓硫酸、饱和$\ce{Na2CO3}$溶液、乙酸乙酯、蒸馏水、3 mol/L $\ce{H2SO4}$溶液、 6 mol/L $\ce{NaOH}$溶液
            \item 用pH计或酸碱指示剂测定溶液pH的变化
            \item $\ce{CH3COOH + CH3CH2OH <=>T[浓硫酸][$\triangle$] H2O + CH3COOC2H5}$、$\ce{CH3COOC2H5 + NaOH ->T[$\triangle$] CH3COONa + C2H5OH }$、$\ce{CH3COOH + Na2CO3 -> NaHCO3 + CH3COONa}$
        \end{inparaenum}
    \end{answer}
\end{exercise}
\begin{exercise}
    阅读并完成99页实验有机物常见官能团检验，完成实验中的表格填写。实验目的为\blank 实验仪器为\blank 实验试剂为\blank 完成表格填写。常见官能团检验方法总结如下：碳碳双键：\blank 碳卤键：\blank 酚羟基：\blank 醛基：\blank 乙醇、1-己烯、苯、四氯化碳鉴别方法：\blank 1-丙醇、2-氯丙烷、丙醛、苯酚鉴别方法：\blank （阿司匹林水溶液）加入石蕊现象为\blank ，结论是\blank 加入碳酸氢钠的目的是\blank ，不加会怎样？\blank 加氯化铁现象为\blank ，结论是\blank 问题与讨论答案：\blank
    \begin{answer}
        \begin{inparaenum}[\quad\textsuperscript{\arabic{enumi}}]
            \item[\setcounter{enumi}{1}\textsuperscript{\arabic{enumi}}] 检验常见官能团
            \item 试管、试管夹、胶头滴管、烧杯、研钵、酒精灯、三脚架、陶土网、火柴
            \item 1-己烯、1-溴丁烷、无水乙醇、苯酚稀溶液、乙醛溶液、苯、1-丙醇、2-氯丙烷、 丙醛、四氯化碳、阿司匹林片、饱和溴水、酸性$\ce{KMnO4}$溶液、5\% NaOH溶液、10\% NaOH溶液、稀硝酸、稀硫酸、2\% $\ce{AgNO3}$溶液、5\% $\ce{CuSO4}$溶液、$\ce{FeCl3}$溶液、$\ce{NaHCO3}$溶液、石蕊溶液
            \item 滴加溴水，溴水褪色；或滴加酸性高锰酸钾溶液，紫色褪去
            \item 加入NaOH水溶液共热，冷却后滴入稀硝酸酸化，再滴加硝酸银，有 白色/淡黄色/黄色 沉淀
            \item 滴加三氯化铁，溶液显色
            \item 银镜反应、斐林试剂
            \item 向待测液滴加溴水（烯使溴水褪色）$\rightarrow$取待测液滴入水中，观察是否溶解、浮沉（乙醇与水互溶，苯浮于水面，四氯化碳沉于水底）
            \item 向待测液滴加三氯化铁溶液（酚羟基与三氯化铁显色）$\rightarrow$斐林试剂（醛产生砖红色沉淀）
            \item 溶液变红
            \item 阿司匹林水溶液呈酸性
            \item 中和稀硫酸，使$\ce{PhO-}$大量存在，有利于配位显色
            \item 显色效果不明显
            \item 出现显色反应
            \item 水杨酸分子中含有酚羟基
            \item 乙酸乙酯，乙醇，乙酸
...
\end{exercise}
\begin{exercise}
    糖类化合物一般由\blank 三种元素组成，大多满足通式\blank ，因此糖类有称为\blank ，事实上有些糖类物质不满足该通式，如\blank ，有些满足该通式但不属于糖类，如\blank ，但目前糖的该别称仍在沿用。从分子结构上看，糖类是\blank 、\blank 和它们的脱水化合物，可分为单糖如：\blank 、\blank 、\blank 、\blank 等、寡糖或低聚糖（2-10），如二糖：\blank 、\blank 、\blank 等、多糖（10以上）如：\blank 、\blank 、\blank 等。自然界分布最广的单糖为\blank ，其结构式为\blank 。

    \begin{answer}
        \begin{inparaenum}[\quad\textsuperscript{\arabic{enumi}}]
            \item[\setcounter{enumi}{1}\textsuperscript{\arabic{enumi}}] 碳、氢、氧
            \item $\ce{C_m(H2O)_n}$
            \item 碳水化合物
            \item 脱氧核糖
            \item 乙酸
            ...
            \item 纤维素
            \item 糖原
            \item 葡萄糖\vspace{0.5em}
            \item $\chemfig{[,0.6] OHC-C(-[6]OH)(-[2]H)-C(-[2]OH)(-[6]H)-C(-[6]OH)(-[2]H)-C(-[6]OH)(-[2]H)-CH_2OH}$
        \end{inparaenum}
    \end{answer}
\end{exercise}
\begin{exercise}
    阅读并完成103页实验4-1。实验目的为\blank 实验仪器和药品为\blank 实验（1）中现象为\blank ，反应方程式为\blank 实验（2）中现象为\blank ，反应方程式为\blank 两个现象与实验3-7,3-8比较，实验结论为：\blank 葡萄糖提供人体热量的化学方程式：\blank 葡萄糖分子中的\blank 可以与分子内的\blank 作用，形成两种六元环状结构。在葡萄糖水溶液中，存在着链状和环状结构葡萄糖之间的平衡，其中绝大部分葡萄糖为环状结构。很多单糖，以及寡糖和多糖中的单糖单元多以\blank 结构的形式存在。
    \begin{figure}[ht!]
        \centering
        \includegraphics[width=0.5\textwidth]{assists/image16.png}
    \end{figure}
    葡萄糖、果糖、蔗糖甜度比较：\blank 葡萄糖和果糖属于\blank，分子式相同，其结构式为\blank 葡萄糖和果糖都是还原性糖，如何理解\blank 分别写出核糖和脱氧核糖的结构式\blank 核糖和脱氧核糖能发生的反应类型有\blank 手性碳原子是\blank 甘油醛的对映异构体结构分别为\blank 自然界中的葡萄糖和果糖都具有\blank 构型。蔗糖在酸或酶作用下水解为\blank ，化学方程式为\blank 麦芽糖在酸或酶作用下水解为\blank ，化学方程式为\blank 乳糖也是二糖，乳糖发酵得到\blank ，是酸奶酸味的主要来源。
    \begin{answer}
        \begin{inparaenum}[\quad\textsuperscript{\arabic{enumi}}]
            \item[\setcounter{enumi}{1}\textsuperscript{\arabic{enumi}}] 验证葡萄糖有醛基、是还原糖
            \item 试管、烧杯、酒精灯、铁架台（带铁夹）、试管夹、胶头滴管、银氨溶液、10\% 葡萄糖溶液、10\% NaOH溶液、5\% $\ce{CuSO4}$溶液
            \item 洁净的试管内壁上形成一层光亮如镜的银层
            \item $\ce{2[Ag(NH3)2]+ + CH2OH(CHOH)4-CHO + 2OH- ->T[$\triangle$] 2Ag v + CH2OH(CHOH)4-COO- + 3NH3 + NH4+ + H2O}$
            \item 产生砖红色沉淀
            \item $\ce{ CH2OH(CHOH)4-CHO + 2Cu(OH)2 + OH- ->T[$\triangle$] CH2OH(CHOH)4-COO- + Cu2O v + 3H2O }$
            \item 葡萄糖有醛基、是还原糖
            \item $\mathop{\ce{C6H12O6}}\limits_{\mbox{\kaishu 葡萄糖}}\ce{+ 6O2 ->T[酶] 6CO2 + 6H2O}$
            \item 醛基
            \item 羟基
            \item 环状结构
            \item 果糖>蔗糖>葡萄糖
            \item 同分异构体
            \item $\chemfig{[,0.6] CH_2OH-C(=[2]O)-C(-[2]OH)(-[6]H)-C(-[6]OH)(-[2]H)-C(-[6]OH)(-[2]H)-CH_2OH}$
            \item 葡萄糖含有醛基，可被弱氧化剂氧化，所以是还原糖；而果糖虽没有直观的醛基，但是酮糖在碱性条件下是不稳定的，\vspace{0.5em}通过一个烯二醇中间体，与葡萄糖和甘露糖相互转化，葡萄糖是还原性糖
            \item $\chemfig{[,0.6] OHC-C(-[6]OH)(-[2]H)-C(-[6]OH)(-[2]H)-C(-[6]OH)(-[2]H)-CH_2OH}$、$\chemfig{[,0.6] OHC-C(-[6]H)(-[2]H)-C(-[6]OH)(-[2]H)-C(-[6]OH)(-[2]H)-CH_2OH}$
            \item 取代反应、氧化反应、\vspace{0.5em}还原反应、消去反应
            \item 连有4个不同的原子或原子团的碳原子
            \item $\chemfig{[,0.6] C(-OH)(-[2]CHO)(-[4]H)(-[6]CH_2OH)}$、$\chemfig{[,0.6] C(-[4]HO)(-[2]CHO)(-H)(-[6]CH_2OH)}$
            \item D
            \item 葡萄糖和果糖
            \item $\mathop{\ce{C12H22O11}}\limits_{\mbox{\kaishu 蔗糖}}\ce{+ H2O ->T[酸或酶]}\mathop{\ce{C6H12O6}}\limits_{\mbox{\kaishu 葡萄糖}}\ce{+}\mathop{\ce{C6H12O6}}\limits_{\mbox{\kaishu 果糖}}$
            \item 葡萄糖
            \item $\mathop{\ce{C12H22O11}}\limits_{\mbox{\kaishu 麦芽糖}}\ce{+ H2O ->T[酸或酶]}\mathop{\ce{2C6H12O6}}\limits_{\mbox{\kaishu 葡萄糖}}$
            \item 乳酸
        \end{inparaenum}
    \end{answer}
    \begin{note}
        题\textsuperscript{8}涉及的糖类代谢过程远复杂于此，详见三羧酸循环。
    \end{note}
\end{exercise}
\begin{exercise}
    阅读并完成106页探究蔗糖和麦芽糖是否属于还原糖，完成实验中的表格填写。实验目的为\blank 实验仪器和试剂为\blank 讨论1答案\blank 讨论2答案\blank 蔗糖和麦芽糖是否为同分异构体，理由是\blank 木糖醇结构式为\blank 阿斯巴甜结构式为\blank 糖精钠结构式\blank 三者是否为糖类，为什么可以用于低糖低热量的食品生产\blank
    \begin{answer}
        \begin{inparaenum}[\quad\textsuperscript{\arabic{enumi}}]
            \item[\setcounter{enumi}{1}\textsuperscript{\arabic{enumi}}] 探究蔗糖和麦芽糖是否属于还原糖
            \item 试管、烧杯、酒精灯、铁架台（带铁夹）、试管夹、胶头滴管、银氨溶液、10\% 葡萄糖溶液、10\% NaOH溶液、5\% $\ce{CuSO4}$溶液
            \item 蔗糖不是还原糖，麦芽糖是
            \item 试管必须极其洁净、试剂现配现用\chdots
            \item 是，分子式相同
            \item $\chemfig{[,0.6] OHC-C(-[6]OH)(-[2]H)-C(-[2]OH)(-[6]H)-C(-[6]OH)(-[2]H)-CH_2OH}$
            \item $\chemfig{[,0.6] HOOC-CH_2-CH(-[6]NH_2)-C(=[2]O)-CH(-[6]COOCH_3)-CH_2-*6([,0.4]-=-=-=)}$\vspace{-1.5em}
            \item $\chemfig{[,0.5] *6(-=?-(-(=[2]O)-[:-30]NNa\cdot 2H_2O-[6]S?O_2)=-=)}$
            \item 不是，因为这些甜味剂的甜度可达到蔗糖的百倍以上，且代谢产生的热量低，不易使人发生龋齿，成本低廉
        \end{inparaenum}
    \end{answer}
\end{exercise}
\addtocounter{exercise}{1}
\setcounter{subexercise}{0}
\begin{subexercise}
    淀粉和纤维素的分子式可表示为\blank ，两者是否同分异构体，理由是\blank 淀粉是白色粉末状物质，\blank 甜味，不溶于冷水，在热水中\blank ，形成\blank ，可利用\blank 现象检验淀粉的存在。天然淀粉由\blank 和\blank 组成（具体结构见108页图4-3），\blank 含量越高，黏性越强。淀粉\blank 被银氨溶液和氢氧化铜等弱氧化剂氧化，属于\blank 糖。淀粉\blank 发生酯化反应是因为\blank 。淀粉可以在\blank 作用下水解，最终生成\blank ，化学方程式为\blank 。淀粉酿酒的方程式为\blank 。\blank 是自然界中分布最广的一种多糖，参与构成了植物的细胞壁，起着\blank 作用，它是地球上来源十分丰富的\blank 资源，且原料成本低，易于发展\blank 能源。
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.2\textwidth]{assists/image17.png}
    \end{figure}
    \begin{answer}
        \begin{inparaenum}[\quad\textsuperscript{\arabic{enumi}}]
            \item[\setcounter{enumi}{1}\textsuperscript{\arabic{enumi}}] $\ce{(C6H10O5)_n}$
            \item 不是，因为聚合度$n$不确定
            \item 没有
            \item 部分溶解
            \item 胶状的淀粉糊
            ...
            \item 酸或酶
            \item 葡萄糖
            \item $\mathop{\ce{(C6H10O5)_n}}\limits_{\mbox{\kaishu 淀粉}}\ce{+ n H2O ->T[酸或酶] }\mathop{\ce{n C6H12O6}}\limits_{\mbox{\kaishu 葡萄糖}}$
            \item $\mathop{\ce{n C6H12O6}}\limits_{\mbox{\kaishu 葡萄糖}} \ce{->T[酵母] 2 C2H5OH + 2 CO2 ^ }$
            \item 纤维素
            \item 支持和保护
            \item 可再生
            \item 生物质
...
\end{subexercise}
\begin{subexercise}
    \fs{[2024·安徽卷]}D－乙酰氨基葡萄糖是一种天然存在的特殊单糖。下列有关该物质说法正确的是\quad(\quad)
    \begin{figure}[ht!]
        \centering
        \includegraphics[width=0.2\textwidth, keepaspectratio]{assists/image18.png}
    \end{figure}\vspace{-1.5em}
    \begin{adjustwidth}{4em}{}
        \begin{asparaenum}[A. ]
            \item 分子式为$\ce{C8H14O6N}$
            \item 能发生缩聚反应
            \item 与葡萄糖互为同系物
            \item 分子中含有$\sigma$键，不含$\pi$键
        \end{asparaenum}
    \end{adjustwidth}
    ...
    \end{answer}
    \begin{point}
        共价键的分类、结构式与分子式、同系物的概念、缩聚反应
    \end{point}
    \begin{explanation}
        分子数为$\ce{C8H15O6N}$，A选项错误；含有羟基，可脱水缩合形成糖苷链，能发生缩聚反应，B选项正确；同系物要求分子式只能相差若干个$\ce{-CH2-}$，而葡萄糖不含氮元素，不是同系物，C选项错误；分子中含有羰基，有一个$\pi$键，D选项错误。
    \end{explanation}
\end{subexercise}
\begin{subexercise}
    \fs{[2023·湖北卷]}中科院院士研究发现，纤维素可在低温下溶于NaOH溶液，恢复至室温后不稳定，加入尿素可得到室温下稳定的溶液，为纤维素绿色再生利用提供了新的解决方案。下列说法错误的是\quad(\quad)
    \begin{figure}[ht!]
        \centering
        \includegraphics[width=0.5\textwidth, keepaspectratio]{assists/image19.png}
    \end{figure}\vspace{-1.5em}
    \begin{adjustwidth}{4em}{}
        \begin{asparaenum}[A. ]
            \item 纤维素是自然界分布广泛的一种多糖
            \item 纤维素难溶于水的主要原因是其链间有多个氢键
            \item NaOH提供$\ce{OH-}$破坏纤维素链之间的氢键
            \item 低温降低了纤维素在NaOH溶液中的溶解性
        \end{asparaenum}
    \end{adjustwidth}
    \begin{answer}
        D
    ...
    \end{point}
    \begin{explanation}
        纤维素可在低温下溶于NaOH溶液，恢复至室温后不稳定，即低温时稳定性好，D选项错误。
    \end{explanation}
\end{subexercise}
\begin{exercise}
    阅读并完成108页实验4-2。实验目的为\blank 实验仪器和药品为\blank 浓硫酸的作用为\blank ，氢氧化钠的作用为\blank 实验现象为\blank ，解释实验现象\blank ，反应方程式为\blank 纤维素是白色\blank 状物质，\blank 甜味，不溶于水，\blank 一般的有机溶剂。纤维素\blank 被银氨溶液和氢氧化铜等弱氧化剂氧化，属于\blank 糖。纤维素可以在\blank 作用下水解，最终生成\blank ，化学方程式为\blank 。在人体内纤维素的作用为\blank 。纤维素用途广泛，\blank 用于纺织工业，\blank 用于造纸原料，还可以用于制造纤维素硝酸酯（硝酸纤维，用途：\blank ）、纤维素乙酰酯（醋酸纤维，用途\blank ）和黏胶纤维（长纤维叫\blank ，短纤维叫\blank ）。甲壳质由\blank 相互结合而成，是一种来源丰富的\blank 资源，不溶于水和一般有机溶剂，但可以在\blank 条件下脱去乙酰基，生成以\blank 为单体的高聚物\blank ，该高聚物含\blank 官能团，易于结构修饰得到不同衍生物，可用于食品医药防止造纸环保领域使用，还具有\blank 性，可制成药物载体、手术缝合线、环保包装袋等。
    \begin{answer}
        \begin{inparaenum}[\quad\textsuperscript{\arabic{enumi}}]
            \item[\setcounter{enumi}{1}\textsuperscript{\arabic{enumi}}] 验证淀粉在酸性环境下能够水解，且水解产物为还原性糖
            \item 试管、脱脂棉、蒸馏水、浓硫酸、玻璃棒、氢氧化钠溶液、5\% 硫酸铜、酒精灯、铁架台（带铁夹）
            \item 作催化剂，催化纤维素水解
            \item 与硫酸铜反应，制备斐林试剂，为还原糖的检测提供碱性环境
            \item 产生砖红色沉淀
            \item 脱脂棉在硫酸的催化作用下，历经一系列中间产物，水解为葡萄糖，与斐林试剂反应，将氢氧化铜还原为氧化亚铜砖红色沉淀
            \item $\mathop{\ce{(C6H10O5)_n}}\limits_{\mbox{\kaishu 纤维素}}\ce{+ n H2O ->T[酸或酶] }\mathop{\ce{n C6H12O6}}\limits_{\mbox{\kaishu 葡萄糖}}$、$\ce{ CH2OH(CHOH)4-CHO + 2Cu(OH)2 + OH- ->T[$\triangle$] CH2OH(CHOH)4-COO- + Cu2O v + 3H2O }$
            \item 纤维
            \item 没有
            \item 不溶于
            \item 不能
            ...
            \item 酸或酶
            \item 葡萄糖
            \item $\mathop{\ce{(C6H10O5)_n}}\limits_{\mbox{\kaishu 纤维素}}\ce{+ n H2O ->T[酸或酶] }\mathop{\ce{n C6H12O6}}\limits_{\mbox{\kaishu 葡萄糖}}$
            \item 促进消化、预防便秘、维持肠道健康、调节血糖水平（可溶性纤维素能在肠道内形成粘稠的凝胶状物质，延缓胃排空速度，并包裹住食物。这使得碳水化合物的消化吸收速度变慢，从而防止餐后血糖急剧上升）、降低胆固醇水平（可溶性纤维素可以与肠道中的胆汁酸（由胆固醇合成）结合，并随粪便将其排出体外。为了弥补流失的胆汁酸，身体就需要动用血液中的胆固醇来合成新的胆汁酸）
            \item 棉和麻
            \item 木材、秸秆等
            \item 生产火药、塑料和涂料等
            \item 生产塑料、过滤膜、胶片等
...
\begin{subexercise}
    \begin{multicols}{2}
        \noindent 完110页第1题（糖类的概念及性质）\\
        完成111页第2题（淀粉与纤维素的异同）\\
        完成111页第3题（糖类物质的性质）\\
        完成111页第4题（淀粉检验）\\
        完成111页5题（核糖和脱氧核糖的性质）\\
        完成111页第6题（淀粉酿酒）\\
        完成111页第7题（有机推断，有机物被氧化的容易程度）\\
        完成111页第8题（质疑、批判精神）
    \end{multicols}
    \begin{answer}
        \fs{略}
...
\end{subexercise}
\begin{subexercise}
    \fs{[2024·安徽卷]}下列资源利用中，在给定工艺条件下转化关系正确的是\quad(\quad)
    \begin{center}
        \begin{inparaenum}[\qquad A. ]
            \item[\setcounter{enumi}{1}A. ] 煤$\ce{->T[干馏]}$石油
            \item 石油$\ce{->T[分馏]}$乙烯
            \item 油脂$\ce{->T[皂化]}$甘油
            \item 淀粉$\ce{->T[水解]}$乙醇
        \end{inparaenum}
    ...
    \end{point}
    \begin{explanation}
        煤与石油无法相互转化，A选项错误；通过分馏，只能从石油中提取饱和烃，要得到乙烯，还需要裂解，B选项错误；油脂可水解为甘油，C选项正确；淀粉水解后只能得到葡萄糖，要得到乙醇还需发酵，D选项错误。
    \end{explanation}
\end{subexercise}
\addtocounter{exercise}{1}
\setcounter{subexercise}{0}
